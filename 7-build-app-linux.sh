...
reportgenerator "-title:teamManager Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:teamManager Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/teamManager_tests
./publish_linux/bin/teamManagerapp
...
reportgenerator "-title:teamManager Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" 

"-sourcedirs:src/utility/src;src/utility/header;src/teamManager/src;src/teamManager/header;src/teamManagerapp/src;src/teamManagerapp/header;src/tests/utility;src/tests/teamManager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
reportgenerator "-reports:**/coverage_linux.info" "-targetdir:assets/codecoverageliblinux" "-reporttypes:Badges" "-sourcedirs:src/utility/src;src/utility/header;src/teamManager/src;src/teamManager/header;src/teamManagerapp/src;src/teamManagerapp/header;src/tests/utility;src/tests/teamManager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
cp -R src/teamManager/header build_linux/build/Release
...
cp -R src/teamManager/header build_linux/build/Debug
