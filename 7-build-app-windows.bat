...
call reportgenerator "-title:teamManager Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:teamManager Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for teamManager
call OpenCppCoverage.exe --export_type=binary:teamManager_tests_unit_win.cov --sources src\teamManager\src --sources src\teamManager\header --sources src\tests\teamManager -- build_win\build\Debug\teamManager_tests.exe

echo Generate Test Coverage Data for teamManager App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=teamManager_tests_unit_win.cov --export_type=cobertura:teamManagerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\teamManager\src --sources src\teamManager\header --sources src\teamManagerapp\src --sources src\teamManagerapp\header --sources src\tests\utility --sources src\tests\teamManager -- build_win\build\Debug\teamManagerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:teamManager Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/teamManagerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/teamManager/src;src/teamManager/header;src/teamManagerapp/src;src/teamManagerapp/header;src/tests/utility;src/tests/teamManager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/teamManagerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/teamManager/src;src/teamManager/header;src/teamManagerapp/src;src/teamManagerapp/header;src/tests/utility;src/tests/teamManager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\teamManager\header "build_win\build\Release" /E
call robocopy src\teamManagerapp\header "build_win\build\Release" /E
...
call robocopy src\teamManager\header "build_win\build\Debug" /E
call robocopy src\teamManagerapp\header "build_win\build\Debug" /E
